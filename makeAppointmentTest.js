...
fixture('CURA Healthcare Service Make Appointment Test')
  .page(page.homeURL);


test('Iterate HealthCare Programs', async t=> {
  await t
  ...
  await t
    for (var i= 0; i < hpArray; i++)
      await t.click(appt.healthcareProgram[i]);
  await t
    .click(appt.hpNone)
